...
import dev.bahodir.firestoredatabaseandstoragefirebaseentrance.databinding.FragmentSaqlanganlarBinding
...
class SaqlanganlarFragment : Fragment() {
    ...
    private var _binding: FragmentSaqlanganlarBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSaqlanganlarBinding.inflate(inflater, container, false)
        ...
        rvForToolBar = RVForToolBar(requireContext(), list, object : RVForToolBar.OnItemTouchListener {
            ...
            override fun savedClick(users: Users, position: Int, view: View) {
                ...
                rvForToolBar.notifyItemRemoved(position)
                rvForToolBar.notifyItemRangeChanged(position, list.size)
