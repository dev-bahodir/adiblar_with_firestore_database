 ...
 * Use the [MumtozAdabiyotiFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class MumtozAdabiyotiFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentMumtozAdabiyotiBinding.inflate(inflater, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment MumtozAdabiyotiFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            MumtozAdabiyotiFragment().apply {
